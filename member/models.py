...
class Member(models.Model):
    member_id = models.CharField(min_length=4, max_length=12, primary_key=True)  # 회원 ID (PK)
    member_type = models.CharField(max_length=20,
                                   choices=[("admin", "관리자"), ("owner", "대표"),
                                            ("manager", "점주"),("normal","일반회원")])
                                            # 회원 유형 (관리자, 점주, 대표, 일반 회원)
    name = models.CharField(min_length=2, max_length=50)
    ...
    member_password = models.CharField(min_length=4, max_length=12)  # 비밀번호
    ...
    store_num = models.CharField(min_length=10, max_length=13)  # 매장 전화번호
