document.addEventListener("DOMContentLoaded", function () {
    ...
    function updatePoints() {
        ...
        console.log("상품 정보:", productDictionary);

        // 먼저 결제 완료 처리 (OrderInfo, OrderItem, PaymentInfo 생성)
        fetch("/kiosk/complete_payment/", {
            ...
            body: JSON.stringify({
                ...
                productDictionary: productDictionary  // 상품 정보 추가
            }),
        })
        ...
        .then(data => {
            ...
            return fetch("/kiosk/update_points/", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "X-CSRFToken": getCSRFToken(),
