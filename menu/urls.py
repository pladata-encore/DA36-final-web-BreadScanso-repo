...
urlpatterns = [
    ...
    path('store/menu_info/<int:item_id>/', views.menu_store_menu_info, name='menu_store_menu_info'),  # 각각의 메뉴 관리 상세 페이지
    path('store/menu_edit/<int:item_id>/', views.menu_store_menu_edit, name='menu_store_menu_edit'),  # 각각의 메뉴 관리 수정 페이지
]
